 ...
 */
export interface parametrizedFlavor<flavorProps extends object = object, flavorName  = string> {
 ...
 * @typeParam flavorProps the props of the flavor factory that cooked the type so flavored
 */
export type flavor<flavorProps extends object = object, flavorName  = string> =
  | flavorName
...
export class vClass<value = any, flavorProps extends object = object> {
  ...
  constructor(vClass_props: vClass_props<value, flavorProps>) {
    ...
    const { flavorName, typeName = flavorName, props :flavorProps} =
      typeof flavor === 'string' ? { flavorName: flavor as string ,props:{}} : (flavor as parametrizedFlavor<flavorProps>)
    this.typeName = typeName
    this.flavorName = flavorName
    //@ts-ignore TODO: gotta figure it out
