...
export default class SiderMenu extends PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, oldState) {
    if (nextProps.location.pathname !== oldState.pathname) {
      return {
  ...
  static getDefaultCollapsedSubMenus(props) {
    ...
    snippets = snippets.map(item => {
      return this.getSelectedMenuKeys(`/${item}`, props.menuData)[0];
    });
    // eg. ['list','list/search']
    return snippets;
  }
   ...
   * /user/chen => /user/:id
   */
  static getSelectedMenuKeys = (path, menus) => {
  ...
  render() {
    ...
    let selectedKeys = SiderMenu.getSelectedMenuKeys(pathname, this.props.menuData);
